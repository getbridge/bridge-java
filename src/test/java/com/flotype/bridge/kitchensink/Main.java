...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		final Bridge bridge = new Bridge().setHost("localhost").setPort(8090)
				.setApiKey("abcdefgh");
		...
		SomeServiceClient service = bridge.getService("someService",
				SomeServiceClient.class);
		List<String> list = Arrays.asList("foo", "bar");
		Map<String, String> map = new HashMap<String, String>();
		map.put("foo", "bar");
		service.someFn(1, 1.0f, "foo", true, null, list, map); // TEST

		SomeServiceClient channel = bridge.getChannel("someChannel",
				SomeServiceClient.class);
